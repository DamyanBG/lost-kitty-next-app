...
import { ADD_CAT_URL, FOUND_CATS_URL, LOST_CATS_URL, SEACH_BY_PASSPORT_ID_URL as SEARCH_BY_PASSPORT_ID_URL, SEACH_BY_MICROCHIP_URL as SEARCH_BY_MICROCHIP_URL, TOTAL_FOUND_URL, TOTAL_LOST_URL } from "@/utils/urls";
...
export const getPaginatedLostCats = async (offset: number, limit: number): Promise<Array<CatResponse>> => {
...
export const getPaginatedFoundCats = async (offset: number, limit: number): Promise<Array<CatResponse>> => {
